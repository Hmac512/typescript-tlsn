...
export class ChaChaRng {
    ...
    constructor(seedBytes: Uint8Array | Array<number>, stream: bigint = 0n) {
        ...
        // this.stream = stream
        this.seed = seedBytes;
        let nonce = int64ToUint8Array(stream);
    ...
    nextU8() {
        let n = nextFromBytes(1, this.cipher);
        return n;
    }
...
function int64ToUint8Array(value: bigint): Uint8Array {
    ...
    let result = new Uint8Array([0, 0, 0, 0, ...uint8Array]);
